...
echo "<h1 style='font-size:14px; text-decoration:none;' id='remarks_email'></h1>"; 

if(count($data) == 0){
    echo "<h3 style='float:left; margin:50px auto;'>0 TRANSACTION FOUND.</h3>";
}
